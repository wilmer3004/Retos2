...
// Creamos un bucle para que se ejecute siempre y cuando el usuario no haya adivinado la palabra
        ...
        System.out.println("¿Señor usuario ya logro adivinar la palabra? \n1. si \n2. no\nElija: ");
        // Capturamos la respuesta
        respuesta = entrada.nextInt();
        entrada.nextLine();
        }
        System.out.println("Ingrese cada una de las letras si ya logro adivinar la palabra");
